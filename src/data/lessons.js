export const lessons = [
  ...
  },
  {
    ...
    instructions: [
      ...
      "실행 후 결과가 수식 모양(5+7)이 아니라, 계산이 완료된 깔끔한 숫자 **12**로 나오는지 확인해봐요!"
    ],
  ...
  },
  {
    ...
    instructions: [
      ...
      "실행 후 콘솔에 영어로 **True**가 깔끔하게 출력되는지 확인해봐요!",
  ...
  },
  {
    ...
    story: "보물 보석 10개를 3명의 친구들에게 공평하게 한 상자씩 나누어 주면, 각각 3개씩 가질 수 있고 1개의 보석이 남게 돼요! 🍪\n\n파이썬은 나눗셈을 할 때 '몇 번 나누어 담겼는지(몫)'와 '다 나누고 찌꺼기가 얼마나 남았는지(나머지)'를 각각 따로 계산할 수 있어요.\n\n* **`//` (몫 연산자)**: 슬래시를 연속 두 개 쓰면, 나눗셈을 한 뒤 소수점 이하는 버리고 오로지 딱 정수로만 몇 번 들어가는지 **몫**만 알려줘요. 예: `10 // 3` -> `3`\n* **`%` (나머지 연산자)**: 퍼센트 기호를 쓰면, 나눗셈을 하고 남은 찌꺼기인 **나머지**만 구해줘요. 짝수와 홀수, 배수를 판정할 때 엄청 유용하답니다! 예: `10 % 3` -> `1`",
    instructions: [
  ...
  },
  {
    ...
    instructions: [
      ...
      "두 조건이 모두 진실이라 전체 판정으로 **True**가 깔끔하게 노출되는지 확인해봐요!"
    ],
  ...
  },
  {
    ...
    instructions: [
      ...
      "한쪽만 참이어도 너그러운 판사인 or 덕분에 최종 결과가 **True**로 인쇄되는지 확인해 보세요!"
    ],
  ...
  },
  {
    ...
    instructions: [
      ...
      "실행 후, 맨 아래 적힌 print(add(3, 5)) 문을 통해 화면에 계산 완료 정답인 **8**이 예쁘게 찍히는지 확인하세요!"
    ],
